...
It's a valid (and important) outcome for this conversation to surface that there isn't a user problem yet — only a business desire. In that case, name it and suggest pausing the spec until the user problem is clearer. Better to catch this here than after building.

Draft the Problem Statement (1-3 paragraphs) once you have a clear user-side pain. Describe the pain and its impact on real people. Don't name the proposed solution. Don't use user-story format ("As a user, I want...").

Show the draft and iterate. A good problem statement should make someone who knows nothing about the project understand why this work matters for the people experiencing the pain.
